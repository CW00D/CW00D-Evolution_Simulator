...
class Simulation_Screen():
    ...
    def move_organisms(self):
        for organism_to_move in self.organisms:
            ...
            if movement_direction == 0:
                movemvent_direction = self.move_up(organism_to_move)
            
            if movement_direction == 1:
                movemvent_direction = self.move_right(organism_to_move)
            
            if movement_direction == 2:
                movemvent_direction = self.move_down(organism_to_move)

            if movement_direction == 3:
                movemvent_direction = self.move_left(organism_to_move)
    ...
    def move_up(self, organism_to_move):
        if organism_to_move.y_position > 0:
            if self.tile_array[organism_to_move.x_position][organism_to_move.y_position-1].tile_type == "Blank":
                ...
                session.commit()
                print("Moving up to", tile_to_move_to)
                return 0
            else:
                return 4
        else:
    ...
    def move_right(self, organism_to_move):
        if organism_to_move.x_position < self.map_size-1:
            if self.tile_array[organism_to_move.x_position+1][organism_to_move.y_position].tile_type == "Blank":
                ...
                tile_to_move_to.tile_type = "Organism"
                session.commit()
                print("Moving right to", tile_to_move_to)
                return 1
            else:
                return 4
        else:
    ...
    def move_down(self, organism_to_move):
        if organism_to_move.y_position < self.map_size-1:
            if self.tile_array[organism_to_move.x_position][organism_to_move.y_position+1].tile_type == "Blank":
                ...
                tile_to_move_to.tile_type = "Organism"
                session.commit()
                print("Moving down to", tile_to_move_to)
                return 2
            else:
                return 4
        else:
    ...
    def move_left(self, organism_to_move):
        if organism_to_move.x_position > 0:
            if self.tile_array[organism_to_move.x_position-1][organism_to_move.y_position].tile_type == "Blank":
                ...
                tile_to_move_to.tile_type = "Organism"
                session.commit()
                print("Moving left to", tile_to_move_to)
                return 3
            else:
                return 4
        else:
    ...
    def check_area_around(self, tile):
        for neighbour in tile.neighbouring_tiles:
            ...
            elif neighbour.tile_type == "Meat" or neighbour.tile_type == "Veg" or neighbour.tile_type == "Fruit":
                print("Eating food")
            elif neighbour.tile_type == "Water":
                print("Drink water")
