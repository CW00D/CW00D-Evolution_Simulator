...
class Simulation_Screen():
    ...
    def position_veg(self):
        proportion_of_veg = round(int(self.simulation_map.meat_to_veg_ratio.split(":")[1])/(int(self.simulation_map.meat_to_veg_ratio.split(":")[0])+int(self.simulation_map.meat_to_veg_ratio.split(":")[1])))
    ...
    def position_meat(self):
        proportion_of_meat = round(int(self.simulation_map.meat_to_veg_ratio.split(":")[0])/(int(self.simulation_map.meat_to_veg_ratio.split(":")[0])+int(self.simulation_map.meat_to_veg_ratio.split(":")[1])))
