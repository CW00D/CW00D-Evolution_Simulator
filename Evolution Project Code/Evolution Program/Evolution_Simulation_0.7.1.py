...
class Custom_Detail_Entry_screen():
    def __init__(self):
        ...
        self.number_of_water_sources = self.menu.add_text_input("Number of Food Sources:  ", default="25")
...
class Saved_Simulations_screen():
    ...
    def load_simulation_1(self):
        simulation = Program.user_logged_in.simulations_relationship[0]
    ...
    def load_simulation_2(self):
        simulation = Program.user_logged_in.simulations_relationship[1]
        simulation.date_last_used = datetime.now()
        session.commit()
        Program.current_simulation=simulation
        self.generate()
    ...
    def load_simulation_3(self):
        simulation = Program.user_logged_in.simulations_relationship[2]
        simulation.date_last_used = datetime.now()
        session.commit()
        Program.current_simulation=simulation
        self.generate()
